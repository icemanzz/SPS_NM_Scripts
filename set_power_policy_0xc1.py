...
if(sts == PASS):
	...
	sts = set_nm_power_policy_py(ipmi, domain, enable_switch , policy_id , c1h_no_policy_trigger, create_switch , c1h_auto_aggressive, c1h_presistent, c1h_alert_enable, c1h_shutdown_disable, AC_power_side, cap_value, correction_time, c1h_trigger_limit_null, c1h_minimum_report_period )
